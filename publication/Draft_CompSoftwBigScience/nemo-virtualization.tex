...
Figure \ref{fig-frplots} show the utilization of virtual machines which were orchestrated by ROCED depending on the resource demands of the users of the KIT group. At peak times, up to 9000 virtual cores were filled with user jobs, which was at that time more than half of the 16.000 cores of the initial NEMO cluster.
...
The usage of the hybrid cluster model is shown in figure~\ref{fig-nodeusage}.
...
while other groups still had to wait for the research software to be deployed on
